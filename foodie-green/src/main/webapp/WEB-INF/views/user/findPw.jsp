...
<%@ include file="../home/header.jsp"%>
	...
	<button type="button" class="sendKeyBtn" onclick="sendSecretkey();">인증번호 요청</button>
	
	<input type="text" placeholder="인증번호를 입력해주세요" id="checkKey" class="input">
	<button type="button" class="authKeyBtn" onclick="authSecretkey();">인증번호 확인</button>
