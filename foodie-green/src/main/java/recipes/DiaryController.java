...
public class DiaryController {
	...
	public ResponseEntity<String> saveDiary(@RequestParam("title") String title,
			@RequestParam("contents") String contents, @RequestParam("recipes") String recipes,
	...
	public ResponseEntity<String> deleteDiary(@PathVariable int diary_id, HttpSession session) {
		String loggedInUserNickname = (String) session.getAttribute("nickname");
		boolean result = ds.deleteDiary(diary_id, loggedInUserNickname);
	...
	@GetMapping("/editDiary/{diary_id}")
	public String editDiary(@PathVariable int diary_id, Model model) {
		DiaryDTO diary = ds.getDiaryById(diary_id);
		model.addAttribute("diary", diary);
		return "recipes/editdiary";
	}

	@PostMapping("/updateDiary/{diary_id}")
	public ResponseEntity<String> updateDiary(@PathVariable int diary_id, 
