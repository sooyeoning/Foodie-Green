$(document).ready(function() {
	...
	<input type="text" name="email" placeholder="이메일을 입력해주세요" id="loginInput" class="emailwhite">
	<input type="text" name="pw" placeholder="비밀번호를 입력하세요" id="loginInput" class="pwwhite">
